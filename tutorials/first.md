...
**1. Open Brillo
You can press [[ctrl]] + [[+]] to zoom in / increase font size as much as you need
Likewise, you can press [[ctrl]] + [[-]] to zoom out.**

![](https://colony-recorder.s3.amazonaws.com/files/2023-02-02/f804d773-b423-4766-9429-775ea1207c1f/stack_animation.webp)

## Loading your data

**2. Click "Browse directories" to input your files
...
For aixACCT, only [.dat] files will work. Make sure you exported in this format.
Select the files you want.**

![](https://colony-recorder.s3.amazonaws.com/files/2023-02-02/803bd697-2d6e-4df5-9c11-902149019153/stack_animation.webp)

**3. Now the right side of the app is available to you, including the following options:
1. Show table data
2. Edit table data
3. Plotting data
4. Macros**
...
**None. You will be able to use the right portion of the program only if you actually loaded some files.**

**4. Great! You have now successfully loaded your files. If you want to load different files, reopen the program.
...
In this case our file is called [[BFO_BT_react_sint_1040_6h_P_E.dat]].
...
**7. Also note that pre-table constants will show up above (in the case of aixACCT it will only read [[area]] and [[thickness]], but you can always add your own by clicking the [[+]] button next to them)**
...
After selecting cm^2 - the value for [[area]] constant updates across the entire dataset (all tables of all files) to this unit
You can change the units as much as you want.
The values update once more.
You can do the same with the thickness.
Let's change the unit to [[cm]].**
...
**9. After we played around with everything [[show table data]] has to offer - let's move onto [[edit table data]]**
...
Now we can click the trash bin button [["🗑"]] to delete the columns we unselected.**
...
**12. Let's go to [["Show table data"]] to see if it has truly been deleted.
...
**13. As we can see -  the [[CH3 [V] ]] column is no more.**
...
**14. We can do other things with [[Edit table data]] as well, let's open it back up.
We can [[Create new columns]] from existing columns in our data.
...
Alright, we have set up all of the options within the [[Create new columns]] menu.
...
**17. Click on [[Show table data]] to see this new column pop up.**
...
**21. Let's try out another operation of [[Edit table data]]**
...
**23. Check if this column showed up in [[Show table data]]**
